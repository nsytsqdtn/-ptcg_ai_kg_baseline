...
# Load deck.csv from this agent folder first, then keep the Kaggle fallback.
file_path = Path(__file__).with_name("deck.csv")
if not file_path.exists():
    kaggle_path = Path("/kaggle_simulations/agent/deck.csv")
    file_path = kaggle_path if kaggle_path.exists() else file_path
