...
AGENT_DIR = ROOT / "agents" / "crustle_mega_kangaskhan_rule_compact_v3"
...
def test_compact_v3_agent_counts_safe_action_fallback(monkeypatch):
    module = load_module("compact_v3_main_fallback", AGENT_DIR / "main.py")
...
def test_compact_v3_play_match_reports_agent_fallback_counts():
    runner = load_module("battle_env_runner_compact_v3_fallback_counts", ROOT / "battle_env" / "runner.py")

    result = runner.play_match("crustle_mega_kangaskhan_rule_compact_v3", "mega_lucario_beginner", capture_details=False)
